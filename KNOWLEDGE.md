...
- Invariant (unit-test this): Pick first, then rotate: 360/n slices, clockwise, +5–7 turns, land on slice centre. ~3.4s. Haptics ease into a landing climax.
- Empty: The wheel is empty. Add names or dares.
- Fake that fails: A coin flip or a text reveal without rotation math.
